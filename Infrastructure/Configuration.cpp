...
/** $VER: Configuration.cpp (2025.10.04) **/
...
cfg_var_modern::cfg_int     CfgPlayerType                   ({ 0x1253bac2, 0x9193, 0x420c, { 0xa9, 0x19, 0x9a, 0x1c, 0xf8, 0x70, 0x6e, 0x2c } }, (t_int32) PlayerType::Default);
...
cfg_var_modern::cfg_int     CfgMIDIOutDeviceId              ({ 0x179600fc, 0x3cf5, 0x42e9, { 0x89, 0x22, 0x0d, 0xf8, 0x90, 0xbf, 0xaa, 0xce } }, 0);    // Identifier of the selected MIDI output device
cfg_var_modern::cfg_string  CfgMIDIOutDeviceName            ({ 0x70ab3c46, 0x43dd, 0x410f, { 0x9f, 0x6a, 0x6d, 0x3c, 0xe3, 0x3c, 0x4a, 0xca } }, "");   // Name of the selected MIDI output device
...
cfg_var_modern::cfg_int     CfgFadeTime                     ({ 0xdcd88167, 0x4d45, 0x4d72, { 0xa8, 0x54, 0xbe, 0x3f, 0x0a, 0xed, 0x00, 0x86 } }, DefaultFadeOutTime);
...
cfg_var_modern::cfg_bool    CfgUseSCWithGS                  ({ 0xca00dbfb, 0x7278, 0x4e38, { 0x8c, 0x2f, 0xe1, 0xbd, 0x9b, 0xeb, 0xcd, 0xd0 } }, DefaultUseSCWithGS);
...
cfg_var_modern::cfg_float   CfgBASSMIDIGain                 ({ 0x143e8051, 0xa42b, 0x4225, { 0xb9, 0xd2, 0x79, 0xf1, 0x43, 0x1e, 0x70, 0x16 } }, DefaultBASSMIDIGain);
...
cfg_var_modern::cfg_bool    CfgBASSMIDIUseDLS               ({ 0xf6b907a9, 0x2ed6, 0x4392, { 0x82, 0x50, 0xc1, 0x57, 0xfe, 0x52, 0x93, 0x6c } }, DefaultBASSMIDIUseDLS);
...
cfg_var_modern::cfg_bool    CfgFluidSynthUseDLS             ({ 0x389d499e, 0x3fc4, 0x4e32, { 0xb0, 0x14, 0x3f, 0xb9, 0xd5, 0x41, 0xa0, 0x27 } }, DefaultFluidSynthUseDLS);
...
cfg_var_modern::cfg_float   CfgSecretSauceGain              ({ 0x38241962, 0x8e6b, 0x4c6c, { 0x96, 0x56, 0x9b, 0x58, 0x73, 0xaa, 0x72, 0xbc } }, DefaultSecretSauceGain);

cfg_var_modern::cfg_string  CfgPlugInName                   ({ 0xf6b1bdff, 0x5d92, 0x4bee, { 0xb6, 0x5f, 0xec, 0x0f, 0x45, 0xe8, 0xd9, 0x39 } }, "");

cfg_vsti_map                CfgVSTiConfig                   ({ 0x44e7c715, 0xd256, 0x44c4, { 0x8f, 0xb6, 0xb7, 0x20, 0xfa, 0x9b, 0x31, 0xfc } });
cfg_clap_map                CfgCLAPConfig                   ({ 0x72dadbea, 0x9330, 0x4bcf, { 0x83, 0x14, 0x55, 0xba, 0x36, 0x24, 0x64, 0x66 } });
