...
/** $VER: Configuration.cpp (2024.05.16) **/
...
const GUID PreferencesRecomposerPageGUID    = {0x19bb1820,0x3b64,0x403c,{0xab,0xf0,0x3d,0xd0,0x06,0x37,0xf2,0x7a}};

static const GUID GUIDCfgPlayerType = { 0x1253bac2, 0x9193, 0x420c, { 0xa9, 0x19, 0x9a, 0x1c, 0xf8, 0x70, 0x6e, 0x2c } };
static const GUID GUIDCfgSampleRate = { 0xae5ba73b, 0xb0d4, 0x4261, { 0xbf, 0xf2, 0x11, 0xa1, 0xc4, 0x4e, 0x57, 0xea } };
...
static const GUID GUIDMIDIPlayerBranch = { 0x66524470, 0x7ec7, 0x445e, { 0xa6, 0xfd, 0xc0, 0xfb, 0xae, 0x74, 0xe5, 0xfc } };
    ...
    static const GUID GUIDCfgADLBank = { 0xa62a00a7, 0xdbf, 0x4475, { 0xbe, 0xca, 0xed, 0xbf, 0x5d, 0x6, 0x4a, 0x80 } };
    static const GUID GUIDCfgADLChipCount = { 0x974365ed, 0xd4f9, 0x4daa, { 0xb4, 0x89, 0xad, 0x7a, 0xd2, 0x91, 0xfa, 0x94 } };
    static const GUID GUIDCfgADLPanning = { 0xad6821b4, 0x493f, 0x4bb3, { 0xb7, 0xbb, 0xe0, 0xa6, 0x7c, 0x5d, 0x59, 0x7 } };
//  static const GUID guid_cfg_adl_4op = { 0xc5fb4053, 0x75bf, 0x4c0d, { 0xa1, 0xb1, 0x71, 0x73, 0x86, 0x32, 0x88, 0xa6 } };

    static const GUID GUIDCfgGMSet = { 0x7257ac7, 0x9901, 0x4a5f, { 0x9d, 0x8b, 0xc5, 0xb5, 0xf1, 0xb8, 0xcf, 0x5b } };
    ...
    static const GUID GUIDCfgNukeSynth = { 0x7423a720, 0xeb39, 0x4d7d, { 0x9b, 0x85, 0x52, 0x4b, 0xc7, 0x79, 0xb5, 0x8b } };
...
cfg_var_modern::cfg_int
    ...
    CfgMuntGMSet(GUIDCfgGMSet, DefaultGMSet),

    CfgADLBank(GUIDCfgADLBank, DefaultADLBank),
    CfgADLChipCount(GUIDCfgADLChipCount, DefaultADLChipCount),
    CfgADLPanning(GUIDCfgADLPanning, DefaultADLPanning),
...
cfg_var_modern::cfg_string
    ...
    CfgFluidSynthDirectoryPath(GUIDCfgFluidSynthDirectoryPath, "");
...
advconfig_branch_factory AdvCfgMIDIPlayerBranch(STR_COMPONENT_NAME, GUIDMIDIPlayerBranch, advconfig_branch::guid_branch_playback, 0);
    ...
    advconfig_branch_factory AdvBASSMIDIBranch("BASSMIDI", GUIDAdvCfgBASSMIDIBranch, GUIDMIDIPlayerBranch, 6.0);
        ...
        advconfig_integer_factory AdvCfgBASSMIDIVoices         ("Maximum voice count",                 GUIDAdvCfgBASSMIDIVoices, GUIDAdvCfgBASSMIDIBranch,  1.0, 256, 1, 100000);
        advconfig_checkbox_factory AdvCfgBASSMIDIEffectsEnabled("Enable reverb and chorus processing", guid_cfg_bassmidi_effects, GUIDAdvCfgBASSMIDIBranch, 2.0, true);
