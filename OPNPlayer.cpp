...
bool OPNPlayer::startup()
{
	...
	for (unsigned i = 0; i < 3; i++)
	{
		...
		default:
		case 0:
			_bank = bnk_xg; _banksize = sizeof(bnk_xg);
			break;

		case 1:
			_bank = bnk_gs; _banksize = sizeof(bnk_gs);
			break;

		case 2:
			_bank = bnk_gems; _banksize = sizeof(bnk_gems);
			break;

		case 3:
			_bank = bnk_Tomsoft; _banksize = sizeof(bnk_Tomsoft);
			break;

		case 4:
			_bank = bnk_fmmidi; _banksize = sizeof(bnk_fmmidi);
			break;
		}
