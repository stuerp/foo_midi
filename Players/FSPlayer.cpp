...
/** $VER: FSPlayer.cpp (2025.06.29) P. Stuer **/
...
//      _FluidSynth.SetIntegerSetting(Setting, "synth.chorus.nr", 3); // 0 - 99
        ...
        */
        ...
        // Create the synthesizer.
        {
            ...
            _FluidSynth.SetReverb(_Synths[i], _DoReverbAndChorusProcessing ? 1 : 0);
            ...
            _FluidSynth.SetChorus(_Synths[i], _DoReverbAndChorusProcessing ? 1 : 0);
