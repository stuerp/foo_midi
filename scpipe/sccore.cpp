...
bool SCCore::Load(const wchar_t * pathName) noexcept
{
    ...
    //  *(void **) &TG_XPgetCurSystemConfig = (void *) ::GetProcAddress((HMODULE)handle, "TG_XPgetCurSystemConfig");
        *(void **) &TG_Process = (void *) ::GetProcAddress((HMODULE) _hModule, "TG_Process");
        ...
        if (TG_initialize && /*TG_terminate &&*/ TG_activate && /*TG_deactivate &&*/ TG_setSampleRate && TG_setMaxBlockSize && TG_flushMidi && TG_setInterruptThreadIdAtThisTime && /*TG_PMidiIn &&*/ TG_ShortMidiIn && TG_LongMidiIn && /*TG_isFatalError && TG_getErrorStrings &&*/ TG_XPgetCurTotalRunningVoices && /*TG_XPsetSystemConfig && TG_XPgetCurSystemConfig &&*/ TG_Process)
            return true;
