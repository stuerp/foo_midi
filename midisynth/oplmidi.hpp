...
namespace opl{
    ...
    public:
        envelope_generator(int AR, int DR, int RR, int SL, int TL);
    ...
    private:
        ...
        int AR, DR, RR, TL;
        uint_least32_t fAR, fDR, fRR, fSL, fTL, fOR, fSS, fDRR, fDSS;
    ...
    class fm_operator{
    public:
        fm_operator(int AR, int DR, int RR, int SL, int TL, int KS, int WS, int key);
        ...
        void add_modulation(int_least32_t x){ wg.add_modulation(x); }
    ...
    private:
		...
		fm_operator op3;
		fm_operator op4;
        wave_generator vibrato_lfo;
        wave_generator tremolo_lfo;
		int ops;
        int ALG;
        int FB[2];
        float freq;
